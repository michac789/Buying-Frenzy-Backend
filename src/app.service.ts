    ...
    <body>
      <div class="container">
        ...
        <p>
          ...
          <span>Please <a href="https://ntusu-api-static-prod.s3.ap-southeast-1.amazonaws.com/static/special/GlintsChallengeREADMEPDF.pdf" target="_blank">click here to see README.md</a> for the detailed project overview, tech stack and tools used here, including database schema and complete API documentation, plus test cases I made.</span>
